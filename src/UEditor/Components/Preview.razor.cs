...
namespace UEditor
{
    public partial class Preview : ComponentBase
    {
        ...
        private const string defaultLazyloadImage = "https://cdn.jsdelivr.net/npm/UEditor/dist/images/img-loading.svg";
        ...
        {
            await Js.InvokeVoidAsync("UEditorBlazor.preview", _ref, DotNetObjectReference.Create(this), this.Markdown, this.Options);
        }
